...
function AppShell() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center" style={{ background: '#C7D8F5' }}>
      <div className="relative w-full max-w-[430px] min-h-screen flex flex-col overflow-hidden bg-[#EEF3FF] shadow-2xl">

        {/* Page content — fills space above frozen nav */}
        <div className="flex-1 flex flex-col overflow-hidden min-h-0 pb-28">
          {renderScreen()}
        </div>
